...
$consulta=mysql_query("select * from libros where id_categoria = 13 limit 0,6");
...
<head>
    ...
    <title>Libros Informatica</title>
	...
	<br>
			<div class="container">
			     <div class="row">
			         ...
			         <div class="col-md-7">
			          <img src="images/informatica.jpg" width="600" height="300">
			         </div>

			         <div class="col-md-5">
			            <h3>Libros de informatica</h3>
			            <p>
			            	Estos libros te ayudaran a aprender y entender el mundo de la informatica en todos sus aspectos, con estos
			            	libros los estudiantes podran usar esta herramienta que hoy es tan importante en cualquier ambito. En algunos de
			            	los Libros puedes aprender a desarrollar programas sistemas completos.
			         </div>
