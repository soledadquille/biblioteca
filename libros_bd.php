...
$consulta=mysql_query("select * from libros where id_categoria = 11 limit 0,6");
	...
	<br>
			<div class="container">
			     <div class="row">
			         ...
			         <div class="col-md-7">
			          <img src="images/bd.jpg" width="600" height="300">
			         </div>

			         <div class="col-md-5">
			            <h3>Libros sobre base de datos</h3>
			            <p>
			            	Con estos libros puedes aprender a manejar y gestionar todas las bases de datos del mundo. Estos son algunos
			            	de los Libros que puedes aprender a desarrollar programas, aplicaciones moviles, aplicaciones de escritorio, 
			            	sitios web dinamicos, sistemas de informacion empresariales, entre otras cosas, el stock actual de libros es poco pero a
			            	medida que pase el tiempo se irán agregando mas libros en esta biblioteca.
			            </p>
			         </div>
