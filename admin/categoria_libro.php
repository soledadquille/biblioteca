...
<body>
            ...
            <div class="container-fluid">
             <br>
                ...
                <h1 class="page-header">
                            <small><img src="images/logo.png"></small> Categorias
                        </h1>
                <!-- /.row -->
    <section>
    <table border="0" align="left">
        ...
        <td width="335"><input type="text" placeholder="Busca por Nombre" id="bs-prod" style="border-radius:10px; padding-left:5px; heigth:25px; width:90%" /></td>
            ...
            <td></td>
            <td></td>
            <td width="100"><button id="nuevo-producto" class="btn btn-success">Nueva Categoria</button></td>
            <td>&nbsp; &nbsp;</td>
            <td width="200"></td>
        </tr>
    </table>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header" style="background:#839ca9;">
              ...
              <h4 class="modal-title" style="color:white;" id="myModalLabel"><b>Mantenimiento de Categorias</b></h4>
            </div>
