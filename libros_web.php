...
$consulta=mysql_query("select * from libros where id_categoria = 2 limit 0,5");
	...
	<br>
			<div class="container">
			     <div class="row">
			         ...
			         <div class="col-md-7">
			          <img src="images/disenoweb.jpg" width="600" height="300">
			         </div>

			         <div class="col-md-5">
			            <h3>Libros para diseñar aplicaciones web</h3>
			            <p>
			            	Estos son algunos de los Libros que puedes aprender a desarrollar sitios y aplicaciones web para el uso en el internet
			            	ademas programas, aplicaciones moviles, aplicaciones de escritorio, sitios web dinamicos, sistemas de informacion 
			            	empresariales, entre otras cosas, el stock actual de libros es poco pero a
